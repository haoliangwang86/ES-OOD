...
from utility import get_inter_outputs, get_statistics, load_ood_detector, load_standard_scaler, sort_csv_results
...
def detect_oods(model_name, ind_name, ood_name):
    ...
    fpr_at_95_tpr, auroc, aupr_out, aupr_in = get_statistics(y_test, max_scores)
    ...
    print()
    return fpr_at_95_tpr, auroc, aupr_out, aupr_in
